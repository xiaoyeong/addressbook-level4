...
| know where to make the payment if the payment is to be done in person
...
| Low
| user
| know how much money that I have loaned that person
| keep records of the amount of money that I have loaned to that person
