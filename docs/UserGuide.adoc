...
Depending on format, this command matches the inputted substring with the names of persons involved in current
transactions, or in past transactions. +
...
To delete a transaction (that the user deems to have been paid off) from the current transactions list,
and add it to the past transactions list. +
