...
public abstract class AddressBookSystemTest {
    ...
    protected void showAllPersons() {
        ...
        assertEquals(getModel().getFinancialDatabase().getPersonList().size(), getModel().getFilteredPersonList().size());
    }
    ...
    protected void showPersonsWithName(String keyword) {
        ...
        assertTrue(getModel().getFilteredPersonList().size() < getModel().getFinancialDatabase().getPersonList().size());
    }
