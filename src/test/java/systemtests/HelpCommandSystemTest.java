 ...
 */
public class HelpCommandSystemTest extends FinancialDatabaseSystemTest {
    ...
    public void openHelpWindow() {
        ...
        executeCommand(SelectCommand.COMMAND_WORD + " " + INDEX_FIRST_TRANSACTION.getOneBased());
        ...
        executeCommand(DeleteCommand.COMMAND_WORD + " " + INDEX_FIRST_TRANSACTION.getOneBased());
