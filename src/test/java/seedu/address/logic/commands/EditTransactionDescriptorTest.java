...
public class EditTransactionDescriptorTest {
    ...
    public void equals() {
        ...
        EditTransactionDescriptor editedAmy = new EditTransactionDescriptorBuilder(DESC_AMY).withName(VALID_NAME_BOB)
                .build();
        ...
        editedAmy = new EditTransactionDescriptorBuilder(DESC_AMY).withEmail(VALID_EMAIL_BOB).build();
        assertFalse(DESC_AMY.equals(editedAmy));
        ...
        editedAmy = new EditTransactionDescriptorBuilder(DESC_AMY).withTags(VALID_TAG_HUSBAND).build();
        assertFalse(DESC_AMY.equals(editedAmy));
    }
}
