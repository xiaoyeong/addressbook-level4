...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Transaction expectedTransaction = new TransactionBuilder(BOB_TRANSACTION).build();
        ...
        Transaction expectedTransactionOfPersonWithMultipleTags = new TransactionBuilder().withPerson(
                new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND).build()).build();

        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, new AddCommand(expectedTransactionOfPersonWithMultipleTags));
    }
