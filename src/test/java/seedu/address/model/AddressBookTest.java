...
public class AddressBookTest {
    ...
    private final FinancialDatabase addressBook = new FinancialDatabase();
    ...
    public void resetData_withDuplicatePersons_throwsDuplicatePersonException() {
        ...
        FinancialDatabaseStub newData = new FinancialDatabaseStub(newPersons);
    ...
    private static class FinancialDatabaseStub implements ReadOnlyFinancialDatabase {
        ...
        FinancialDatabaseStub(Collection<Person> persons) {
