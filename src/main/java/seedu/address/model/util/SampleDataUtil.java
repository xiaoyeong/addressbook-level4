        ...
        return new Transaction[]{
            new Transaction(new Type("debt"), new Amount("SGD 33.00"), new Deadline("15/12/2018"),
                    new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                            ...
                            getTagSet("friends"))),
            new Transaction(new Type("loan"), new Amount("USD 55.50"), new Deadline("17/12/2018"),
            ...
            new Transaction(new Type("loan"), new Amount("MYR 155.50"), new Deadline("17/12/2018"),
            ...
            new Transaction(new Type("loan"), new Amount("IDR 1028.90"), new Deadline("17/12/2018"),
