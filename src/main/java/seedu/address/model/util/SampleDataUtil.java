        ...
        return new Transaction[]{
            new Transaction(new Type("debt"), new Amount("SGD 33.00"), new Deadline("15/10/2018"),
                    new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                            new Address("Blk 30 Geylang Street 29, #06-40"), new UniqueId("1"),
                            getTagSet("friends"))),
            new Transaction(new Type("loan"), new Amount("SGD 55.50"), new Deadline("17/11/2018"), new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
