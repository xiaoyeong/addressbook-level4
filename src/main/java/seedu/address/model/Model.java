...
public interface Model {
    ...
    /**
     * Returns true if a person with the same identity as {@code transaction} exists in the database.
     */
     ...
     * The person identity of {@code editedTransaction} must not be the same as another existing person in the
     * database.
     */
